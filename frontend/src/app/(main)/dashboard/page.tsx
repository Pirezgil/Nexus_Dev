...
import { getCurrentTimeForInput, formatDate } from '@/lib/dates';
...
function DashboardPage() {
  ...
  const getGreeting = () => {
    const currentTime = getCurrentTimeForInput();
  ...
  // CORRIGIDO: Configurar colunas da DataTable no formato TanStack Table
  const tableColumns = [
    {
      id: 'name',
      accessorKey: 'name',
