...
import { servicesApiMethods } from '@/lib/api';
...
import { ArrowLeft, Save, Package, DollarSign, Clock, Tag, Settings } from 'lucide-react';
...
export default function NovoServicoPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await servicesApiMethods.createService(formData);
            ...
            <div>
              ...
              <div className="relative">
                ...
                <Select
                  ...
                  onValueChange={(value: ServiceStatus) => handleInputChange('status', value)}
                >
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div className="text-center">
              <div className="text-2xl font-bold text-blue-600">
                {formData.price ? `R$ ${parseFloat(formData.price || '0').toFixed(2).replace('.', ',')}` : 'R$ 0,00'}
              </div>
