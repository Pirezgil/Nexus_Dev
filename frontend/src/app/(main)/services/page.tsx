...
import { getProfessionalStatusInfo, filterAvailableProfessionals } from '@/utils/professional-status';
            ...
            <div className="flex justify-between items-start">
              <div className="flex-1">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  {(() => {
                    const statusInfo = getProfessionalStatusInfo(professional.status);
                    return (
                      <span className={`px-2 py-1 rounded-full text-xs font-medium ${statusInfo.color} ${statusInfo.textColor}`}>
                        {statusInfo.label}
                      </span>
                    );
                  })()}
